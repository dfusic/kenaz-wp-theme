<aside class="sidebar">
  ...
  <section class="video">
    <h2 class="video-title">Kenaz TV</h2>
    <iframe width="100%" height="200" src="https://www.youtube.com/embed/fJ9rUzIMcZQ?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    <div class="video-info">
      <p class="video-date">August 26, 2013</p>
      <h3 class="video-data">Nasa releases portrait of a planet waving at Saturn</h3>
    </div>
  </section>
